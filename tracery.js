...
var tracery = function() {
    ...
    var baseEngModifiers = {
        ...
        rand : function(s, params) {
            return Math.round(rng() * parseInt(params[0], 10));
        },

        randRange : function(s, params) {
            return Math.round(rng() * (parseInt(params[1], 10) - parseInt(params[0], 10)) + parseInt(params[0], 10));
        },
